...
namespace Vuplex.WebView
{
    ...
    ///     <list type="number">
    ///         <item>
    ///             By dragging the CanvasWebViewPrefab.prefab file into your scene via the editor and setting its "Initial
    ///             URL" property.
    ///         </item>
    ///         <item>
    ...
    public partial class CanvasWebViewPrefab : BaseWebViewPrefab
    {
        ...
        ///     instead of displaying web content as a texture in the Unity scene. The default is `false`. If set to `true` and the
        ///     3D WebView package
        ///     in use doesn't support Native 2D Mode, then the default rendering mode is used instead. This field can only be set
        ///     prior to
        ///     initialization (i.e. prior to when Unity calls Start() for the CanvasWebViewPrefab). Native 2D Mode cannot be
        ///     enabled or disabled
        ...
        ///     API to show the keyboard and then send typed characters to the webview like described in [this
        ///     article](https://support.vuplex.com/articles/how-to-use-a-third-party-keyboard).
        /// </remarks>
        /// <remarks>
        ...
        ///         isn't used because the device's native resolution is used instead. So, the Resolution field's value is
        ///         inaccurate and changes to it are ignored.
        ///     </para>
        /// </remarks>
        /// <example>
        ///     <code>
        ...
        {
            return preferNative2DMode ? _getScreenSpaceRect() : _rectTransform.rect;
        }
        ...
        private float _getScreenSpaceScaleFactor()
        {
            ...
            {
                var scaleFactor = display.systemWidth / (float) display.renderingWidth;
        ...
        private async void _initCanvasPrefab()
        {
            try
            {
                OnInit();
